...
function Exams() {
  ...
  const studyDays: StudyDay[] = [
    {
      day: 1,
      title: "SQL",
      topics: "DDL, DML, DCL, TCL, SELECT queries and joins",
    },
    {
      day: 2,
      title: "ER Model",
      topics: "Entities, attributes, relationships and ER diagrams",
    },
    {
      day: 3,
      title: "Normalization",
      topics: "1NF, 2NF, 3NF, BCNF and functional dependencies",
    },
    {
      day: 4,
      title: "Transactions",
      topics: "ACID properties, transaction states and concurrency",
    },
    {
      day: 5,
      title: "Revision",
      topics: "Important questions, previous papers and quick revision",
    },
  ];
  ...
  const questions = [
    ...
    {
      question: "Which property of a transaction means 'All or Nothing'?",
  ...
  if (activeSection === "preparation" && selectedSubject) {
    return (
      <div className="page">
        ...
        <div className="exam-header">
          ...
          <div className="progress-bar">
            <div
              ...
              style={{
                width: `${selectedSubject.preparation}%`,
              }}
            ></div>
          </div>
        </div>
        ...
        <div className="resource-grid">
          ...
          <div className="resource-card">
            ...
            <h2>Study Plan</h2>
            <p>
              Follow a structured day-by-day plan for your exam.
            </p>
          ...
          <div className="resource-card">
            ...
            <p>
              Focus on the most important topics for your exam.
            </p>
          ...
          <div className="resource-card">
            ...
            <p>
              Test your knowledge using practice questions.
            </p>
          ...
          <div className="resource-card">
            ...
            <h2>AI Guidance</h2>
            <p>
              Get personalized guidance for your preparation.
            </p>
  ...
  if (activeSection === "study-plan") {
    return (
      <div className="page">
        ...
        <p>
          Follow this schedule to prepare effectively for your
          examination.
        </p>
        ...
        <div className="resource-grid">
          ...
          {studyDays.map((day) => (
            <div className="resource-card" key={day.day}>
  ...
  if (activeSection === "study-day" && selectedDay) {
    return (
      <div className="page">
        ...
        <div className="resource-card study-day">
          ...
          <div className="activity-list">
            <div>📖 Read the concepts</div>
            <div>✍️ Write short notes</div>
            <div>💻 Practice examples</div>
            <div>❓ Solve questions</div>
            <div>🔄 Revise before finishing</div>
          </div>
          ...
          <button
            ...
            onClick={() => {
              alert(
                `Day ${selectedDay.day} completed! Great job! 🎉`
              );
            }}
          >
  ...
  if (activeSection === "important-topics") {
    return (
      <div className="page">
        ...
        <p>
          These are the topics you should prioritize before
          your examination.
        </p>
  ...
  if (activeSection === "practice") {
    return (
      <div className="page">
        ...
        <p>
          Test your knowledge and improve your exam preparation.
        </p>
    ...
    return (
      <div className="page">
        ...
        <div className="resource-card ai-card">
          ...
          <h1>AI Exam Guidance</h1>

          <p>
            Get a personalized preparation strategy based on
            your progress.
          </p>
          ...
          <div className="ai-suggestions">
            ...
            <div>
              ...
              <p>
                Use 45 minutes of focused study followed by
                a 10-minute break.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Revise today's topics before starting new ones.
              </p>
            </div>
          ...
          <button
            ...
            onClick={() => {
              alert(
                "AI recommendation generated! Focus on your weak topics and practice more questions. 🤖"
              );
            }}
          >
            Generate My Plan →
  ...
  return (
    <div className="page">
      ...
      <p>
        Use these resources to strengthen your preparation.
      </p>
      ...
      <div className="resource-grid">
        ...
        <div className="resource-card">
          ...
          <h2>GeeksforGeeks SQL</h2>

          <p>
            Practice SQL concepts and database questions.
          </p>
        ...
        <div className="resource-card">
          ...
          <p>
            Learn networking concepts, OSI model and
            TCP/IP.
          </p>
        ...
        <div className="resource-card">
          ...
          <p>
            Learn processes, scheduling, memory management
            and deadlocks.
          </p>
